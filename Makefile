...
install: all
	...
	@sed "s#DWMSRC#${PREFIX}/share/dwm/src/#g" < dwmm > ${DESTDIR}${PREFIX}/bin/dwmm
	...
	@cp -Rf dwm.c bitmaps.h config.def.h config.mk Makefile layouts other  ${DESTDIR}${PREFIX}/share/dwm/src
